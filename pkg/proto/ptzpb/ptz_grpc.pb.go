...
const (
	PtzApi_GetPtz_FullMethodName       = "/smartcore.bos.ptz.v1.PtzApi/GetPtz"
	PtzApi_UpdatePtz_FullMethodName    = "/smartcore.bos.ptz.v1.PtzApi/UpdatePtz"
	PtzApi_Stop_FullMethodName         = "/smartcore.bos.ptz.v1.PtzApi/Stop"
	PtzApi_CreatePreset_FullMethodName = "/smartcore.bos.ptz.v1.PtzApi/CreatePreset"
	PtzApi_PullPtz_FullMethodName      = "/smartcore.bos.ptz.v1.PtzApi/PullPtz"
)
...
var PtzApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.ptz.v1.PtzApi",
	...
	Metadata: "smartcore/bos/ptz/v1/ptz.proto",
}

const (
	PtzInfo_DescribePtz_FullMethodName = "/smartcore.bos.ptz.v1.PtzInfo/DescribePtz"
)
...
var PtzInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.ptz.v1.PtzInfo",
