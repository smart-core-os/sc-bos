...
var _ TemperatureApiServer = (*ApiRouter)(nil)
...
func (r *ApiRouter) AddTemperatureApiClient(name string, client TemperatureApiClient) TemperatureApiClient {
...
func (r *ApiRouter) RemoveTemperatureApiClient(name string) TemperatureApiClient {
	res := r.Remove(name)
	if res == nil {
		return nil
	}
...
func (r *ApiRouter) GetTemperatureApiClient(name string) (TemperatureApiClient, error) {
	res, err := r.Get(name)
	if err != nil {
		return nil, err
	}
...
func (r *ApiRouter) GetTemperature(ctx context.Context, request *GetTemperatureRequest) (*Temperature, error) {
...
func (r *ApiRouter) PullTemperature(request *PullTemperatureRequest, server TemperatureApi_PullTemperatureServer) error {
	child, err := r.GetTemperatureApiClient(request.Name)
	if err != nil {
		return err
	}
...
func (r *ApiRouter) UpdateTemperature(ctx context.Context, request *UpdateTemperatureRequest) (*Temperature, error) {
	child, err := r.GetTemperatureApiClient(request.Name)
	if err != nil {
		return nil, err
	}
