...
const (
	BrightnessSensorApi_GetAmbientBrightness_FullMethodName  = "/smartcore.bos.brightnesssensor.v1.BrightnessSensorApi/GetAmbientBrightness"
	BrightnessSensorApi_PullAmbientBrightness_FullMethodName = "/smartcore.bos.brightnesssensor.v1.BrightnessSensorApi/PullAmbientBrightness"
)
...
var BrightnessSensorApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.brightnesssensor.v1.BrightnessSensorApi",
	...
	Metadata: "smartcore/bos/brightnesssensor/v1/brightness_sensor.proto",
}

const (
	BrightnessSensorInfo_DescribeAmbientBrightness_FullMethodName = "/smartcore.bos.brightnesssensor.v1.BrightnessSensorInfo/DescribeAmbientBrightness"
)
...
var BrightnessSensorInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.brightnesssensor.v1.BrightnessSensorInfo",
