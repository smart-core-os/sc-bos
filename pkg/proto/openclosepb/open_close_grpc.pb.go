...
const (
	OpenCloseApi_GetPositions_FullMethodName    = "/smartcore.bos.openclose.v1.OpenCloseApi/GetPositions"
	OpenCloseApi_UpdatePositions_FullMethodName = "/smartcore.bos.openclose.v1.OpenCloseApi/UpdatePositions"
	OpenCloseApi_Stop_FullMethodName            = "/smartcore.bos.openclose.v1.OpenCloseApi/Stop"
	OpenCloseApi_PullPositions_FullMethodName   = "/smartcore.bos.openclose.v1.OpenCloseApi/PullPositions"
)
...
var OpenCloseApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.openclose.v1.OpenCloseApi",
	...
	Metadata: "smartcore/bos/openclose/v1/open_close.proto",
}

const (
	OpenCloseInfo_DescribePositions_FullMethodName = "/smartcore.bos.openclose.v1.OpenCloseInfo/DescribePositions"
)
...
var OpenCloseInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.openclose.v1.OpenCloseInfo",
