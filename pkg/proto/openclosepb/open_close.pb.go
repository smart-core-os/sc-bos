...
func (OpenClosePosition_Direction) Descriptor() protoreflect.EnumDescriptor {
	return file_smartcore_bos_openclose_v1_open_close_proto_enumTypes[0].Descriptor()
}

func (OpenClosePosition_Direction) Type() protoreflect.EnumType {
	return &file_smartcore_bos_openclose_v1_open_close_proto_enumTypes[0]
}
...
func (OpenClosePosition_Direction) EnumDescriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{1, 0}
}
...
func (OpenClosePosition_Resistance) Descriptor() protoreflect.EnumDescriptor {
	return file_smartcore_bos_openclose_v1_open_close_proto_enumTypes[1].Descriptor()
}

func (OpenClosePosition_Resistance) Type() protoreflect.EnumType {
	return &file_smartcore_bos_openclose_v1_open_close_proto_enumTypes[1]
}
...
func (OpenClosePosition_Resistance) EnumDescriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{1, 1}
}
...
func (x *OpenClosePositions) Reset() {
	*x = OpenClosePositions{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[0]
...
func (*OpenClosePositions) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{0}
}
...
type OpenClosePosition struct {
	...
	Direction OpenClosePosition_Direction `protobuf:"varint,4,opt,name=direction,proto3,enum=smartcore.bos.openclose.v1.OpenClosePosition_Direction" json:"direction,omitempty"`
	...
	Resistance    OpenClosePosition_Resistance `protobuf:"varint,5,opt,name=resistance,proto3,enum=smartcore.bos.openclose.v1.OpenClosePosition_Resistance" json:"resistance,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OpenClosePosition) Reset() {
	*x = OpenClosePosition{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenClosePosition) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{1}
}
...
func (x *PositionsSupport) Reset() {
	*x = PositionsSupport{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GetOpenClosePositionsRequest) Reset() {
	*x = GetOpenClosePositionsRequest{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetOpenClosePositionsRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{3}
}
...
func (x *UpdateOpenClosePositionsRequest) Reset() {
	*x = UpdateOpenClosePositionsRequest{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateOpenClosePositionsRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{4}
}
...
func (x *StopOpenCloseRequest) Reset() {
	*x = StopOpenCloseRequest{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StopOpenCloseRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{5}
}
...
func (x *PullOpenClosePositionsRequest) Reset() {
	*x = PullOpenClosePositionsRequest{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullOpenClosePositionsRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{6}
}
...
func (x *PullOpenClosePositionsResponse) Reset() {
	*x = PullOpenClosePositionsResponse{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullOpenClosePositionsResponse) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{7}
}
...
func (x *DescribePositionsRequest) Reset() {
	*x = DescribePositionsRequest{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DescribePositionsRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{8}
}
...
func (x *OpenClosePositions_Preset) Reset() {
	*x = OpenClosePositions_Preset{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenClosePositions_Preset) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PullOpenClosePositionsResponse_Change) Reset() {
	*x = PullOpenClosePositionsResponse_Change{}
	mi := &file_smartcore_bos_openclose_v1_open_close_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullOpenClosePositionsResponse_Change) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP(), []int{7, 0}
}
...
var File_smartcore_bos_openclose_v1_open_close_proto protoreflect.FileDescriptor
...
const file_smartcore_bos_openclose_v1_open_close_proto_rawDesc = "" +
	...
	"\n" +
	"resistance\x18\x05 \x01(\x0e28.smartcore.bos.openclose.v1.OpenClosePosition.ResistanceR\n" +
	"resistance\"^\n" +
	"\tDirection\x12\x19\n" +
	...
	"directions\x12#\n" +
	"\rsupports_stop\x18\x04 \x01(\bR\fsupportsStop\x12O\n" +
	"\apresets\x18\x05 \x03(\v25.smartcore.bos.openclose.v1.OpenClosePositions.PresetR\apresets\"k\n" +
	"\x1cGetOpenClosePositionsRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x127\n" +
	"\tread_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\breadMask\"\xd0\x01\n" +
	"\x1fUpdateOpenClosePositionsRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12F\n" +
	"\x06states\x18\x02 \x01(\v2..smartcore.bos.openclose.v1.OpenClosePositionsR\x06states\x12\x14\n" +
	...
	"\fupdates_only\x18\x04 \x01(\bR\vupdatesOnly\"\xb9\x02\n" +
	"\x1ePullOpenClosePositionsResponse\x12[\n" +
	"\achanges\x18\x01 \x03(\v2A.smartcore.bos.openclose.v1.PullOpenClosePositionsResponse.ChangeR\achanges\x1a\xb9\x01\n" +
	"\x06Change\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12;\n" +
	"\vchange_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"changeTime\x12^\n" +
	"\x13open_close_position\x18\x03 \x01(\v2..smartcore.bos.openclose.v1.OpenClosePositionsR\x11openClosePosition\".\n" +
	"\x18DescribePositionsRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name2\xfd\x03\n" +
	"\fOpenCloseApi\x12x\n" +
	"\fGetPositions\x128.smartcore.bos.openclose.v1.GetOpenClosePositionsRequest\x1a..smartcore.bos.openclose.v1.OpenClosePositions\x12~\n" +
	"\x0fUpdatePositions\x12;.smartcore.bos.openclose.v1.UpdateOpenClosePositionsRequest\x1a..smartcore.bos.openclose.v1.OpenClosePositions\x12h\n" +
...
var (
	...
	file_smartcore_bos_openclose_v1_open_close_proto_rawDescData []byte
)

func file_smartcore_bos_openclose_v1_open_close_proto_rawDescGZIP() []byte {
	file_smartcore_bos_openclose_v1_open_close_proto_rawDescOnce.Do(func() {
		file_smartcore_bos_openclose_v1_open_close_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_smartcore_bos_openclose_v1_open_close_proto_rawDesc), len(file_smartcore_bos_openclose_v1_open_close_proto_rawDesc)))
	})
	return file_smartcore_bos_openclose_v1_open_close_proto_rawDescData
}

var file_smartcore_bos_openclose_v1_open_close_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_smartcore_bos_openclose_v1_open_close_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_smartcore_bos_openclose_v1_open_close_proto_goTypes = []any{
	(OpenClosePosition_Direction)(0),              // 0: smartcore.bos.openclose.v1.OpenClosePosition.Direction
	(OpenClosePosition_Resistance)(0),             // 1: smartcore.bos.openclose.v1.OpenClosePosition.Resistance
	(*OpenClosePositions)(nil),                    // 2: smartcore.bos.openclose.v1.OpenClosePositions
	(*OpenClosePosition)(nil),                     // 3: smartcore.bos.openclose.v1.OpenClosePosition
	(*PositionsSupport)(nil),                      // 4: smartcore.bos.openclose.v1.PositionsSupport
	(*GetOpenClosePositionsRequest)(nil),          // 5: smartcore.bos.openclose.v1.GetOpenClosePositionsRequest
	(*UpdateOpenClosePositionsRequest)(nil),       // 6: smartcore.bos.openclose.v1.UpdateOpenClosePositionsRequest
	(*StopOpenCloseRequest)(nil),                  // 7: smartcore.bos.openclose.v1.StopOpenCloseRequest
	(*PullOpenClosePositionsRequest)(nil),         // 8: smartcore.bos.openclose.v1.PullOpenClosePositionsRequest
	(*PullOpenClosePositionsResponse)(nil),        // 9: smartcore.bos.openclose.v1.PullOpenClosePositionsResponse
...
var file_smartcore_bos_openclose_v1_open_close_proto_depIdxs = []int32{
	...
	2,  // 10: smartcore.bos.openclose.v1.UpdateOpenClosePositionsRequest.states:type_name -> smartcore.bos.openclose.v1.OpenClosePositions
	16, // 11: smartcore.bos.openclose.v1.UpdateOpenClosePositionsRequest.update_mask:type_name -> google.protobuf.FieldMask
	16, // 12: smartcore.bos.openclose.v1.PullOpenClosePositionsRequest.read_mask:type_name -> google.protobuf.FieldMask
	12, // 13: smartcore.bos.openclose.v1.PullOpenClosePositionsResponse.changes:type_name -> smartcore.bos.openclose.v1.PullOpenClosePositionsResponse.Change
	17, // 14: smartcore.bos.openclose.v1.PullOpenClosePositionsResponse.Change.change_time:type_name -> google.protobuf.Timestamp
	2,  // 15: smartcore.bos.openclose.v1.PullOpenClosePositionsResponse.Change.open_close_position:type_name -> smartcore.bos.openclose.v1.OpenClosePositions
	5,  // 16: smartcore.bos.openclose.v1.OpenCloseApi.GetPositions:input_type -> smartcore.bos.openclose.v1.GetOpenClosePositionsRequest
	6,  // 17: smartcore.bos.openclose.v1.OpenCloseApi.UpdatePositions:input_type -> smartcore.bos.openclose.v1.UpdateOpenClosePositionsRequest
	7,  // 18: smartcore.bos.openclose.v1.OpenCloseApi.Stop:input_type -> smartcore.bos.openclose.v1.StopOpenCloseRequest
	8,  // 19: smartcore.bos.openclose.v1.OpenCloseApi.PullPositions:input_type -> smartcore.bos.openclose.v1.PullOpenClosePositionsRequest
	10, // 20: smartcore.bos.openclose.v1.OpenCloseInfo.DescribePositions:input_type -> smartcore.bos.openclose.v1.DescribePositionsRequest
	2,  // 21: smartcore.bos.openclose.v1.OpenCloseApi.GetPositions:output_type -> smartcore.bos.openclose.v1.OpenClosePositions
	2,  // 22: smartcore.bos.openclose.v1.OpenCloseApi.UpdatePositions:output_type -> smartcore.bos.openclose.v1.OpenClosePositions
	2,  // 23: smartcore.bos.openclose.v1.OpenCloseApi.Stop:output_type -> smartcore.bos.openclose.v1.OpenClosePositions
	9,  // 24: smartcore.bos.openclose.v1.OpenCloseApi.PullPositions:output_type -> smartcore.bos.openclose.v1.PullOpenClosePositionsResponse
	4,  // 25: smartcore.bos.openclose.v1.OpenCloseInfo.DescribePositions:output_type -> smartcore.bos.openclose.v1.PositionsSupport
...
func init() { file_smartcore_bos_openclose_v1_open_close_proto_init() }
func file_smartcore_bos_openclose_v1_open_close_proto_init() {
	if File_smartcore_bos_openclose_v1_open_close_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_smartcore_bos_openclose_v1_open_close_proto_rawDesc), len(file_smartcore_bos_openclose_v1_open_close_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   2,
		},
		GoTypes:           file_smartcore_bos_openclose_v1_open_close_proto_goTypes,
		DependencyIndexes: file_smartcore_bos_openclose_v1_open_close_proto_depIdxs,
		EnumInfos:         file_smartcore_bos_openclose_v1_open_close_proto_enumTypes,
		MessageInfos:      file_smartcore_bos_openclose_v1_open_close_proto_msgTypes,
	}.Build()
	File_smartcore_bos_openclose_v1_open_close_proto = out.File
	file_smartcore_bos_openclose_v1_open_close_proto_goTypes = nil
	file_smartcore_bos_openclose_v1_open_close_proto_depIdxs = nil
}
