...
func (x *AccessAttempt) GetActor() *actorpb.Actor {
	if x != nil {
		return x.Actor
	}
	return nil
...
type AccessGrant struct {
	...
	Grantee *actorpb.Actor `protobuf:"bytes,5,opt,name=grantee,proto3" json:"grantee,omitempty"`
	...
	Granter *actorpb.Actor `protobuf:"bytes,6,opt,name=granter,proto3" json:"granter,omitempty"`
...
func (x *AccessGrant) GetGrantee() *actorpb.Actor {
	if x != nil {
		return x.Grantee
	}
	return nil
...
func (x *AccessGrant) GetGranter() *actorpb.Actor {
	if x != nil {
		return x.Granter
	}
	return nil
...
const file_smartcore_bos_access_v1_access_proto_rawDesc = "" +
	...
	"\x10ListAccessGrants\x120.smartcore.bos.access.v1.ListAccessGrantsRequest\x1a1.smartcore.bos.access.v1.ListAccessGrantsResponse\"\x00B4Z2github.com/smart-core-os/sc-bos/pkg/proto/accesspbb\x06proto3"
...
var file_smartcore_bos_access_v1_access_proto_goTypes = []any{
	...
	(*actorpb.Actor)(nil),                     // 14: smartcore.bos.actor.v1.Actor
