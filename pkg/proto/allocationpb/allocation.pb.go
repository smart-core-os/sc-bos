...
type Allocation struct {
	...
	Actor *actorpb.Actor `protobuf:"bytes,2,opt,name=actor,proto3,oneof" json:"actor,omitempty"`
...
func (x *Allocation) GetActor() *actorpb.Actor {
	if x != nil {
		return x.Actor
	}
	return nil
...
const file_smartcore_bos_allocation_v1_allocation_proto_rawDesc = "" +
	...
	"\x0ePullAllocation\x122.smartcore.bos.allocation.v1.PullAllocationRequest\x1a3.smartcore.bos.allocation.v1.PullAllocationResponse0\x01B8Z6github.com/smart-core-os/sc-bos/pkg/proto/allocationpbb\x06proto3"
...
var file_smartcore_bos_allocation_v1_allocation_proto_goTypes = []any{
	...
	(*actorpb.Actor)(nil),                 // 7: smartcore.bos.actor.v1.Actor
