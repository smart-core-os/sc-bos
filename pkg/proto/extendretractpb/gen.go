...
//go:generate protomod protoc -- -I ../../.. --router_opt=outputPkg=github.com/smart-core-os/sc-bos/pkg/proto/extendretractpb --router_out=../../.. --wrapper_opt=outputPkg=github.com/smart-core-os/sc-bos/pkg/proto/extendretractpb --wrapper_out=../../.. github.com/smart-core-os/sc-api/protobuf/traits/extend_retract.proto
