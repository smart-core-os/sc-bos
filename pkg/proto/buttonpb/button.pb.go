...
func (ButtonState_Press) Descriptor() protoreflect.EnumDescriptor {
	return file_smartcore_bos_button_v1_button_proto_enumTypes[0].Descriptor()
}

func (ButtonState_Press) Type() protoreflect.EnumType {
	return &file_smartcore_bos_button_v1_button_proto_enumTypes[0]
}
...
func (ButtonState_Press) EnumDescriptor() ([]byte, []int) {
	return file_smartcore_bos_button_v1_button_proto_rawDescGZIP(), []int{0, 0}
}
...
func (ButtonState_Gesture_Kind) Descriptor() protoreflect.EnumDescriptor {
	return file_smartcore_bos_button_v1_button_proto_enumTypes[1].Descriptor()
}

func (ButtonState_Gesture_Kind) Type() protoreflect.EnumType {
	return &file_smartcore_bos_button_v1_button_proto_enumTypes[1]
}
...
func (ButtonState_Gesture_Kind) EnumDescriptor() ([]byte, []int) {
	return file_smartcore_bos_button_v1_button_proto_rawDescGZIP(), []int{0, 0, 0}
}

type ButtonState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	State ButtonState_Press      `protobuf:"varint,1,opt,name=state,proto3,enum=smartcore.bos.button.v1.ButtonState_Press" json:"state,omitempty"`
...
func (x *ButtonState) Reset() {
	*x = ButtonState{}
	mi := &file_smartcore_bos_button_v1_button_proto_msgTypes[0]
...
func (*ButtonState) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_button_v1_button_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetButtonStateRequest) Reset() {
	*x = GetButtonStateRequest{}
	mi := &file_smartcore_bos_button_v1_button_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetButtonStateRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_button_v1_button_proto_rawDescGZIP(), []int{1}
}
...
func (x *PullButtonStateRequest) Reset() {
	*x = PullButtonStateRequest{}
	mi := &file_smartcore_bos_button_v1_button_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullButtonStateRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_button_v1_button_proto_rawDescGZIP(), []int{2}
}
...
func (x *PullButtonStateResponse) Reset() {
	*x = PullButtonStateResponse{}
	mi := &file_smartcore_bos_button_v1_button_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullButtonStateResponse) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_button_v1_button_proto_rawDescGZIP(), []int{3}
}
...
func (x *UpdateButtonStateRequest) Reset() {
	*x = UpdateButtonStateRequest{}
	mi := &file_smartcore_bos_button_v1_button_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateButtonStateRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_button_v1_button_proto_rawDescGZIP(), []int{4}
}
...
type ButtonState_Gesture struct {
	...
	Kind ButtonState_Gesture_Kind `protobuf:"varint,2,opt,name=kind,proto3,enum=smartcore.bos.button.v1.ButtonState_Gesture_Kind" json:"kind,omitempty"`
...
func (x *ButtonState_Gesture) Reset() {
	*x = ButtonState_Gesture{}
	mi := &file_smartcore_bos_button_v1_button_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *PullButtonStateResponse_Change) Reset() {
	*x = PullButtonStateResponse_Change{}
	mi := &file_smartcore_bos_button_v1_button_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullButtonStateResponse_Change) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_button_v1_button_proto_rawDescGZIP(), []int{3, 0}
}
...
var File_smartcore_bos_button_v1_button_proto protoreflect.FileDescriptor

const file_smartcore_bos_button_v1_button_proto_rawDesc = "" +
	"\n" +
	"$smartcore/bos/button/v1/button.proto\x12\x17smartcore.bos.button.v1\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcf\x04\n" +
	"\vButtonState\x12@\n" +
	"\x05state\x18\x01 \x01(\x0e2*.smartcore.bos.button.v1.ButtonState.PressR\x05state\x12F\n" +
	"\x11state_change_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x0fstateChangeTime\x12\\\n" +
	"\x13most_recent_gesture\x18\x03 \x01(\v2,.smartcore.bos.button.v1.ButtonState.GestureR\x11mostRecentGesture\x1a\x9b\x02\n" +
	"\aGesture\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12E\n" +
	"\x04kind\x18\x02 \x01(\x0e21.smartcore.bos.button.v1.ButtonState.Gesture.KindR\x04kind\x12\x14\n" +
	...
	"\x17PullButtonStateResponse\x12Q\n" +
	"\achanges\x18\x01 \x03(\v27.smartcore.bos.button.v1.PullButtonStateResponse.ChangeR\achanges\x1a\xa2\x01\n" +
	"\x06Change\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12;\n" +
	"\vchange_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"changeTime\x12G\n" +
	"\fbutton_state\x18\x03 \x01(\v2$.smartcore.bos.button.v1.ButtonStateR\vbuttonState\"\xb4\x01\n" +
	"\x18UpdateButtonStateRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12G\n" +
	"\fbutton_state\x18\x03 \x01(\v2$.smartcore.bos.button.v1.ButtonStateR\vbuttonState2\xd9\x02\n" +
	"\tButtonApi\x12f\n" +
	"\x0eGetButtonState\x12..smartcore.bos.button.v1.GetButtonStateRequest\x1a$.smartcore.bos.button.v1.ButtonState\x12v\n" +
	"\x0fPullButtonState\x12/.smartcore.bos.button.v1.PullButtonStateRequest\x1a0.smartcore.bos.button.v1.PullButtonStateResponse0\x01\x12l\n" +
	"\x11UpdateButtonState\x121.smartcore.bos.button.v1.UpdateButtonStateRequest\x1a$.smartcore.bos.button.v1.ButtonStateB4Z2github.com/smart-core-os/sc-bos/pkg/proto/buttonpbb\x06proto3"

var (
	file_smartcore_bos_button_v1_button_proto_rawDescOnce sync.Once
	file_smartcore_bos_button_v1_button_proto_rawDescData []byte
)

func file_smartcore_bos_button_v1_button_proto_rawDescGZIP() []byte {
	file_smartcore_bos_button_v1_button_proto_rawDescOnce.Do(func() {
		file_smartcore_bos_button_v1_button_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_smartcore_bos_button_v1_button_proto_rawDesc), len(file_smartcore_bos_button_v1_button_proto_rawDesc)))
	})
	return file_smartcore_bos_button_v1_button_proto_rawDescData
}

var file_smartcore_bos_button_v1_button_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_smartcore_bos_button_v1_button_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_smartcore_bos_button_v1_button_proto_goTypes = []any{
	(ButtonState_Press)(0),                 // 0: smartcore.bos.button.v1.ButtonState.Press
	(ButtonState_Gesture_Kind)(0),          // 1: smartcore.bos.button.v1.ButtonState.Gesture.Kind
	(*ButtonState)(nil),                    // 2: smartcore.bos.button.v1.ButtonState
	(*GetButtonStateRequest)(nil),          // 3: smartcore.bos.button.v1.GetButtonStateRequest
	(*PullButtonStateRequest)(nil),         // 4: smartcore.bos.button.v1.PullButtonStateRequest
	(*PullButtonStateResponse)(nil),        // 5: smartcore.bos.button.v1.PullButtonStateResponse
	(*UpdateButtonStateRequest)(nil),       // 6: smartcore.bos.button.v1.UpdateButtonStateRequest
	(*ButtonState_Gesture)(nil),            // 7: smartcore.bos.button.v1.ButtonState.Gesture
	(*PullButtonStateResponse_Change)(nil), // 8: smartcore.bos.button.v1.PullButtonStateResponse.Change
	(*timestamppb.Timestamp)(nil),          // 9: google.protobuf.Timestamp
	(*fieldmaskpb.FieldMask)(nil),          // 10: google.protobuf.FieldMask
}
var file_smartcore_bos_button_v1_button_proto_depIdxs = []int32{
	0,  // 0: smartcore.bos.button.v1.ButtonState.state:type_name -> smartcore.bos.button.v1.ButtonState.Press
	9,  // 1: smartcore.bos.button.v1.ButtonState.state_change_time:type_name -> google.protobuf.Timestamp
	7,  // 2: smartcore.bos.button.v1.ButtonState.most_recent_gesture:type_name -> smartcore.bos.button.v1.ButtonState.Gesture
	10, // 3: smartcore.bos.button.v1.GetButtonStateRequest.read_mask:type_name -> google.protobuf.FieldMask
	10, // 4: smartcore.bos.button.v1.PullButtonStateRequest.read_mask:type_name -> google.protobuf.FieldMask
	8,  // 5: smartcore.bos.button.v1.PullButtonStateResponse.changes:type_name -> smartcore.bos.button.v1.PullButtonStateResponse.Change
	10, // 6: smartcore.bos.button.v1.UpdateButtonStateRequest.update_mask:type_name -> google.protobuf.FieldMask
	2,  // 7: smartcore.bos.button.v1.UpdateButtonStateRequest.button_state:type_name -> smartcore.bos.button.v1.ButtonState
	1,  // 8: smartcore.bos.button.v1.ButtonState.Gesture.kind:type_name -> smartcore.bos.button.v1.ButtonState.Gesture.Kind
	9,  // 9: smartcore.bos.button.v1.ButtonState.Gesture.start_time:type_name -> google.protobuf.Timestamp
	9,  // 10: smartcore.bos.button.v1.ButtonState.Gesture.end_time:type_name -> google.protobuf.Timestamp
	9,  // 11: smartcore.bos.button.v1.PullButtonStateResponse.Change.change_time:type_name -> google.protobuf.Timestamp
	2,  // 12: smartcore.bos.button.v1.PullButtonStateResponse.Change.button_state:type_name -> smartcore.bos.button.v1.ButtonState
	3,  // 13: smartcore.bos.button.v1.ButtonApi.GetButtonState:input_type -> smartcore.bos.button.v1.GetButtonStateRequest
	4,  // 14: smartcore.bos.button.v1.ButtonApi.PullButtonState:input_type -> smartcore.bos.button.v1.PullButtonStateRequest
	6,  // 15: smartcore.bos.button.v1.ButtonApi.UpdateButtonState:input_type -> smartcore.bos.button.v1.UpdateButtonStateRequest
	2,  // 16: smartcore.bos.button.v1.ButtonApi.GetButtonState:output_type -> smartcore.bos.button.v1.ButtonState
	5,  // 17: smartcore.bos.button.v1.ButtonApi.PullButtonState:output_type -> smartcore.bos.button.v1.PullButtonStateResponse
	2,  // 18: smartcore.bos.button.v1.ButtonApi.UpdateButtonState:output_type -> smartcore.bos.button.v1.ButtonState
...
func init() { file_smartcore_bos_button_v1_button_proto_init() }
func file_smartcore_bos_button_v1_button_proto_init() {
	if File_smartcore_bos_button_v1_button_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_smartcore_bos_button_v1_button_proto_rawDesc), len(file_smartcore_bos_button_v1_button_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_smartcore_bos_button_v1_button_proto_goTypes,
		DependencyIndexes: file_smartcore_bos_button_v1_button_proto_depIdxs,
		EnumInfos:         file_smartcore_bos_button_v1_button_proto_enumTypes,
		MessageInfos:      file_smartcore_bos_button_v1_button_proto_msgTypes,
	}.Build()
	File_smartcore_bos_button_v1_button_proto = out.File
	file_smartcore_bos_button_v1_button_proto_goTypes = nil
	file_smartcore_bos_button_v1_button_proto_depIdxs = nil
}
