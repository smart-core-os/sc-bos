...
// ApiRouter is a ButtonApiServer that allows routing named requests to specific ButtonApiClient
...
var _ ButtonApiServer = (*ApiRouter)(nil)
...
func (r *ApiRouter) AddButtonApiClient(name string, client ButtonApiClient) ButtonApiClient {
...
func (r *ApiRouter) RemoveButtonApiClient(name string) ButtonApiClient {
	res := r.Remove(name)
	if res == nil {
		return nil
	}
...
func (r *ApiRouter) GetButtonApiClient(name string) (ButtonApiClient, error) {
	res, err := r.Get(name)
	if err != nil {
		return nil, err
	}
...
func (r *ApiRouter) GetButtonState(ctx context.Context, request *GetButtonStateRequest) (*ButtonState, error) {
...
func (r *ApiRouter) PullButtonState(request *PullButtonStateRequest, server ButtonApi_PullButtonStateServer) error {
	child, err := r.GetButtonApiClient(request.Name)
	if err != nil {
		return err
	}
...
func (r *ApiRouter) UpdateButtonState(ctx context.Context, request *UpdateButtonStateRequest) (*ButtonState, error) {
	child, err := r.GetButtonApiClient(request.Name)
	if err != nil {
		return nil, err
	}
