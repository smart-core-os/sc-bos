...
const (
	AirQualitySensorApi_GetAirQuality_FullMethodName  = "/smartcore.bos.airqualitysensor.v1.AirQualitySensorApi/GetAirQuality"
	AirQualitySensorApi_PullAirQuality_FullMethodName = "/smartcore.bos.airqualitysensor.v1.AirQualitySensorApi/PullAirQuality"
)
...
var AirQualitySensorApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.airqualitysensor.v1.AirQualitySensorApi",
	...
	Metadata: "smartcore/bos/airqualitysensor/v1/air_quality_sensor.proto",
}

const (
	AirQualitySensorInfo_DescribeAirQuality_FullMethodName = "/smartcore.bos.airqualitysensor.v1.AirQualitySensorInfo/DescribeAirQuality"
)
...
var AirQualitySensorInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.airqualitysensor.v1.AirQualitySensorInfo",
