...
func (Image_Source_Purpose) Descriptor() protoreflect.EnumDescriptor {
	return file_smartcore_bos_types_v1_image_proto_enumTypes[0].Descriptor()
}

func (Image_Source_Purpose) Type() protoreflect.EnumType {
	return &file_smartcore_bos_types_v1_image_proto_enumTypes[0]
}
...
func (Image_Source_Purpose) EnumDescriptor() ([]byte, []int) {
	return file_smartcore_bos_types_v1_image_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
func (x *Image) Reset() {
	*x = Image{}
	mi := &file_smartcore_bos_types_v1_image_proto_msgTypes[0]
...
func (*Image) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_types_v1_image_proto_rawDescGZIP(), []int{0}
}
...
func (x *Image_Content) Reset() {
	*x = Image_Content{}
	mi := &file_smartcore_bos_types_v1_image_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Image_Content) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_types_v1_image_proto_rawDescGZIP(), []int{0, 0}
}
...
type Image_Source struct {
	...
	Purpose       Image_Source_Purpose `protobuf:"varint,4,opt,name=purpose,proto3,enum=smartcore.bos.types.v1.Image_Source_Purpose" json:"purpose,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Image_Source) Reset() {
	*x = Image_Source{}
	mi := &file_smartcore_bos_types_v1_image_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Image_Source) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_types_v1_image_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_smartcore_bos_types_v1_image_proto protoreflect.FileDescriptor

const file_smartcore_bos_types_v1_image_proto_rawDesc = "" +
	"\n" +
	"\"smartcore/bos/types/v1/image.proto\x12\x16smartcore.bos.types.v1\"\xdc\x03\n" +
	"\x05Image\x12>\n" +
	"\asources\x18\x01 \x03(\v2$.smartcore.bos.types.v1.Image.SourceR\asources\x12 \n" +
	...
	"\acontent\x1a\xf2\x01\n" +
	"\x06Source\x127\n" +
	"\x03src\x18\x01 \x03(\v2%.smartcore.bos.types.v1.Image.ContentR\x03src\x12\x14\n" +
	"\x05width\x18\x02 \x01(\x05R\x05width\x12\x16\n" +
	"\x06height\x18\x03 \x01(\x05R\x06height\x12F\n" +
	"\apurpose\x18\x04 \x01(\x0e2,.smartcore.bos.types.v1.Image.Source.PurposeR\apurpose\"9\n" +
	"\aPurpose\x12\x17\n" +
	"\x13PURPOSE_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03ANY\x10\x01\x12\f\n" +
	"\bMASKABLE\x10\x02Bh\n" +
	"\x13dev.smartcore.typesB\n" +
	"ImageProtoP\x01Z1github.com/smart-core-os/sc-bos/pkg/proto/typespb\xaa\x02\x0fSmartcore.Typesb\x06proto3"

var (
	file_smartcore_bos_types_v1_image_proto_rawDescOnce sync.Once
	file_smartcore_bos_types_v1_image_proto_rawDescData []byte
)

func file_smartcore_bos_types_v1_image_proto_rawDescGZIP() []byte {
	file_smartcore_bos_types_v1_image_proto_rawDescOnce.Do(func() {
		file_smartcore_bos_types_v1_image_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_smartcore_bos_types_v1_image_proto_rawDesc), len(file_smartcore_bos_types_v1_image_proto_rawDesc)))
	})
	return file_smartcore_bos_types_v1_image_proto_rawDescData
}

var file_smartcore_bos_types_v1_image_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_smartcore_bos_types_v1_image_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_smartcore_bos_types_v1_image_proto_goTypes = []any{
	(Image_Source_Purpose)(0), // 0: smartcore.bos.types.v1.Image.Source.Purpose
	(*Image)(nil),             // 1: smartcore.bos.types.v1.Image
	(*Image_Content)(nil),     // 2: smartcore.bos.types.v1.Image.Content
	(*Image_Source)(nil),      // 3: smartcore.bos.types.v1.Image.Source
}
var file_smartcore_bos_types_v1_image_proto_depIdxs = []int32{
	3, // 0: smartcore.bos.types.v1.Image.sources:type_name -> smartcore.bos.types.v1.Image.Source
	2, // 1: smartcore.bos.types.v1.Image.Source.src:type_name -> smartcore.bos.types.v1.Image.Content
	0, // 2: smartcore.bos.types.v1.Image.Source.purpose:type_name -> smartcore.bos.types.v1.Image.Source.Purpose
...
func init() { file_smartcore_bos_types_v1_image_proto_init() }
func file_smartcore_bos_types_v1_image_proto_init() {
	if File_smartcore_bos_types_v1_image_proto != nil {
		return
	}
	file_smartcore_bos_types_v1_image_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_smartcore_bos_types_v1_image_proto_rawDesc), len(file_smartcore_bos_types_v1_image_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_smartcore_bos_types_v1_image_proto_goTypes,
		DependencyIndexes: file_smartcore_bos_types_v1_image_proto_depIdxs,
		EnumInfos:         file_smartcore_bos_types_v1_image_proto_enumTypes,
		MessageInfos:      file_smartcore_bos_types_v1_image_proto_msgTypes,
	}.Build()
	File_smartcore_bos_types_v1_image_proto = out.File
	file_smartcore_bos_types_v1_image_proto_goTypes = nil
	file_smartcore_bos_types_v1_image_proto_depIdxs = nil
}
