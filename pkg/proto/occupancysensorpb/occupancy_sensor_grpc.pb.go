...
const (
	OccupancySensorApi_GetOccupancy_FullMethodName  = "/smartcore.bos.occupancysensor.v1.OccupancySensorApi/GetOccupancy"
	OccupancySensorApi_PullOccupancy_FullMethodName = "/smartcore.bos.occupancysensor.v1.OccupancySensorApi/PullOccupancy"
)
...
var OccupancySensorApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.occupancysensor.v1.OccupancySensorApi",
	...
	Metadata: "smartcore/bos/occupancysensor/v1/occupancy_sensor.proto",
}

const (
	OccupancySensorInfo_DescribeOccupancy_FullMethodName = "/smartcore.bos.occupancysensor.v1.OccupancySensorInfo/DescribeOccupancy"
)
...
var OccupancySensorInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.occupancysensor.v1.OccupancySensorInfo",
