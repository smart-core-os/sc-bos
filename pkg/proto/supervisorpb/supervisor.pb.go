...
type InstallUpdateRequest struct {
	...
	// The type-prefixed checksum of the artefact ("<algo>:<base64>", e.g. md5 or sha256), verified
	// before installing.
...
func (x *InstallUpdateRequest) GetChecksum() string {
	if x != nil {
		return x.Checksum
	}
	return ""
