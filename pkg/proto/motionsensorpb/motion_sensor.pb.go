...
func (MotionDetection_State) Descriptor() protoreflect.EnumDescriptor {
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_enumTypes[0].Descriptor()
}

func (MotionDetection_State) Type() protoreflect.EnumType {
	return &file_smartcore_bos_motionsensor_v1_motion_sensor_proto_enumTypes[0]
}
...
func (MotionDetection_State) EnumDescriptor() ([]byte, []int) {
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescGZIP(), []int{0, 0}
}
...
type MotionDetection struct {
	...
	State MotionDetection_State `protobuf:"varint,1,opt,name=state,proto3,enum=smartcore.bos.motionsensor.v1.MotionDetection_State" json:"state,omitempty"`
...
func (x *MotionDetection) Reset() {
	*x = MotionDetection{}
	mi := &file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes[0]
...
func (*MotionDetection) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescGZIP(), []int{0}
}
...
func (x *MotionDetectionSupport) Reset() {
	*x = MotionDetectionSupport{}
	mi := &file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GetMotionDetectionRequest) Reset() {
	*x = GetMotionDetectionRequest{}
	mi := &file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetMotionDetectionRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescGZIP(), []int{2}
}
...
func (x *PullMotionDetectionRequest) Reset() {
	*x = PullMotionDetectionRequest{}
	mi := &file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullMotionDetectionRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescGZIP(), []int{3}
}
...
func (x *PullMotionDetectionResponse) Reset() {
	*x = PullMotionDetectionResponse{}
	mi := &file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullMotionDetectionResponse) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescGZIP(), []int{4}
}
...
func (x *DescribeMotionDetectionRequest) Reset() {
	*x = DescribeMotionDetectionRequest{}
	mi := &file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DescribeMotionDetectionRequest) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescGZIP(), []int{5}
}
...
func (x *PullMotionDetectionResponse_Change) Reset() {
	*x = PullMotionDetectionResponse_Change{}
	mi := &file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PullMotionDetectionResponse_Change) Descriptor() ([]byte, []int) {
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescGZIP(), []int{4, 0}
}
...
var File_smartcore_bos_motionsensor_v1_motion_sensor_proto protoreflect.FileDescriptor
...
const file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDesc = "" +
	...
	"\fupdates_only\x18\x03 \x01(\bR\vupdatesOnly\"\xb1\x02\n" +
	"\x1bPullMotionDetectionResponse\x12[\n" +
	"\achanges\x18\x01 \x03(\v2A.smartcore.bos.motionsensor.v1.PullMotionDetectionResponse.ChangeR\achanges\x1a\xb4\x01\n" +
	"\x06Change\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12;\n" +
	"\vchange_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"changeTime\x12Y\n" +
	"\x10motion_detection\x18\x03 \x01(\v2..smartcore.bos.motionsensor.v1.MotionDetectionR\x0fmotionDetection\"4\n" +
	"\x1eDescribeMotionDetectionRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name2\xa5\x02\n" +
	"\x0fMotionSensorApi\x12~\n" +
...
var (
	...
	file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescData []byte
)

func file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescGZIP() []byte {
	file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescOnce.Do(func() {
		file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDesc), len(file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDesc)))
	})
	return file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDescData
}

var file_smartcore_bos_motionsensor_v1_motion_sensor_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_smartcore_bos_motionsensor_v1_motion_sensor_proto_goTypes = []any{
	(MotionDetection_State)(0),                 // 0: smartcore.bos.motionsensor.v1.MotionDetection.State
	(*MotionDetection)(nil),                    // 1: smartcore.bos.motionsensor.v1.MotionDetection
	(*MotionDetectionSupport)(nil),             // 2: smartcore.bos.motionsensor.v1.MotionDetectionSupport
	(*GetMotionDetectionRequest)(nil),          // 3: smartcore.bos.motionsensor.v1.GetMotionDetectionRequest
	(*PullMotionDetectionRequest)(nil),         // 4: smartcore.bos.motionsensor.v1.PullMotionDetectionRequest
	(*PullMotionDetectionResponse)(nil),        // 5: smartcore.bos.motionsensor.v1.PullMotionDetectionResponse
...
var file_smartcore_bos_motionsensor_v1_motion_sensor_proto_depIdxs = []int32{
	...
	7,  // 6: smartcore.bos.motionsensor.v1.PullMotionDetectionResponse.changes:type_name -> smartcore.bos.motionsensor.v1.PullMotionDetectionResponse.Change
	8,  // 7: smartcore.bos.motionsensor.v1.PullMotionDetectionResponse.Change.change_time:type_name -> google.protobuf.Timestamp
	1,  // 8: smartcore.bos.motionsensor.v1.PullMotionDetectionResponse.Change.motion_detection:type_name -> smartcore.bos.motionsensor.v1.MotionDetection
	3,  // 9: smartcore.bos.motionsensor.v1.MotionSensorApi.GetMotionDetection:input_type -> smartcore.bos.motionsensor.v1.GetMotionDetectionRequest
	4,  // 10: smartcore.bos.motionsensor.v1.MotionSensorApi.PullMotionDetections:input_type -> smartcore.bos.motionsensor.v1.PullMotionDetectionRequest
	6,  // 11: smartcore.bos.motionsensor.v1.MotionSensorInfo.DescribeMotionDetection:input_type -> smartcore.bos.motionsensor.v1.DescribeMotionDetectionRequest
	1,  // 12: smartcore.bos.motionsensor.v1.MotionSensorApi.GetMotionDetection:output_type -> smartcore.bos.motionsensor.v1.MotionDetection
	5,  // 13: smartcore.bos.motionsensor.v1.MotionSensorApi.PullMotionDetections:output_type -> smartcore.bos.motionsensor.v1.PullMotionDetectionResponse
	2,  // 14: smartcore.bos.motionsensor.v1.MotionSensorInfo.DescribeMotionDetection:output_type -> smartcore.bos.motionsensor.v1.MotionDetectionSupport
...
func init() { file_smartcore_bos_motionsensor_v1_motion_sensor_proto_init() }
func file_smartcore_bos_motionsensor_v1_motion_sensor_proto_init() {
	if File_smartcore_bos_motionsensor_v1_motion_sensor_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDesc), len(file_smartcore_bos_motionsensor_v1_motion_sensor_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   2,
		},
		GoTypes:           file_smartcore_bos_motionsensor_v1_motion_sensor_proto_goTypes,
		DependencyIndexes: file_smartcore_bos_motionsensor_v1_motion_sensor_proto_depIdxs,
		EnumInfos:         file_smartcore_bos_motionsensor_v1_motion_sensor_proto_enumTypes,
		MessageInfos:      file_smartcore_bos_motionsensor_v1_motion_sensor_proto_msgTypes,
	}.Build()
	File_smartcore_bos_motionsensor_v1_motion_sensor_proto = out.File
	file_smartcore_bos_motionsensor_v1_motion_sensor_proto_goTypes = nil
	file_smartcore_bos_motionsensor_v1_motion_sensor_proto_depIdxs = nil
}
