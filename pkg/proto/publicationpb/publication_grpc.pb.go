...
const (
	PublicationApi_CreatePublication_FullMethodName      = "/smartcore.bos.publication.v1.PublicationApi/CreatePublication"
	PublicationApi_GetPublication_FullMethodName         = "/smartcore.bos.publication.v1.PublicationApi/GetPublication"
	PublicationApi_UpdatePublication_FullMethodName      = "/smartcore.bos.publication.v1.PublicationApi/UpdatePublication"
	PublicationApi_DeletePublication_FullMethodName      = "/smartcore.bos.publication.v1.PublicationApi/DeletePublication"
	PublicationApi_PullPublication_FullMethodName        = "/smartcore.bos.publication.v1.PublicationApi/PullPublication"
	PublicationApi_ListPublications_FullMethodName       = "/smartcore.bos.publication.v1.PublicationApi/ListPublications"
	PublicationApi_PullPublications_FullMethodName       = "/smartcore.bos.publication.v1.PublicationApi/PullPublications"
	PublicationApi_AcknowledgePublication_FullMethodName = "/smartcore.bos.publication.v1.PublicationApi/AcknowledgePublication"
)
...
var PublicationApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.publication.v1.PublicationApi",
	...
	Metadata: "smartcore/bos/publication/v1/publication.proto",
}
