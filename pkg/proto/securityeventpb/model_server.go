...
func (m *ModelServer) Register(server *grpc.Server) {
	RegisterSecurityEventApiServer(server, m)
}
...
func (m *ModelServer) ListSecurityEvents(ctx context.Context, req *ListSecurityEventsRequest) (*ListSecurityEventsResponse, error) {
...
func (m *ModelServer) PullSecurityEvents(request *PullSecurityEventsRequest, server SecurityEventApi_PullSecurityEventsServer) error {
