...
func (r *ServiceRouter) AddUdmiServiceClient(name string, client UdmiServiceClient) UdmiServiceClient {
...
func (r *ServiceRouter) RemoveUdmiServiceClient(name string) UdmiServiceClient {
	res := r.Remove(name)
	if res == nil {
		return nil
	}
...
func (r *ServiceRouter) GetUdmiServiceClient(name string) (UdmiServiceClient, error) {
	res, err := r.Get(name)
	if err != nil {
		return nil, err
	}
...
func (r *ServiceRouter) PullControlTopics(request *PullControlTopicsRequest, server UdmiService_PullControlTopicsServer) error {
...
func (r *ServiceRouter) OnMessage(ctx context.Context, request *OnMessageRequest) (*OnMessageResponse, error) {
	child, err := r.GetUdmiServiceClient(request.Name)
	if err != nil {
		return nil, err
	}
...
func (r *ServiceRouter) PullExportMessages(request *PullExportMessagesRequest, server UdmiService_PullExportMessagesServer) error {
	child, err := r.GetUdmiServiceClient(request.Name)
	if err != nil {
		return err
	}
...
func (r *ServiceRouter) GetExportMessage(ctx context.Context, request *GetExportMessageRequest) (*MqttMessage, error) {
	child, err := r.GetUdmiServiceClient(request.Name)
	if err != nil {
		return nil, err
	}
