...
const (
	OnOffApi_GetOnOff_FullMethodName    = "/smartcore.bos.onoff.v1.OnOffApi/GetOnOff"
	OnOffApi_UpdateOnOff_FullMethodName = "/smartcore.bos.onoff.v1.OnOffApi/UpdateOnOff"
	OnOffApi_PullOnOff_FullMethodName   = "/smartcore.bos.onoff.v1.OnOffApi/PullOnOff"
)
...
var OnOffApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.onoff.v1.OnOffApi",
	...
	Metadata: "smartcore/bos/onoff/v1/on_off.proto",
}

const (
	OnOffInfo_DescribeOnOff_FullMethodName = "/smartcore.bos.onoff.v1.OnOffInfo/DescribeOnOff"
)
...
var OnOffInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.onoff.v1.OnOffInfo",
