...
// ApiRouter is a ColorApiServer that allows routing named requests to specific ColorApiClient
...
var _ ColorApiServer = (*ApiRouter)(nil)
...
func (r *ApiRouter) AddColorApiClient(name string, client ColorApiClient) ColorApiClient {
...
func (r *ApiRouter) RemoveColorApiClient(name string) ColorApiClient {
	res := r.Remove(name)
	if res == nil {
		return nil
	}
...
func (r *ApiRouter) GetColorApiClient(name string) (ColorApiClient, error) {
	res, err := r.Get(name)
	if err != nil {
		return nil, err
	}
...
func (r *ApiRouter) GetColor(ctx context.Context, request *GetColorRequest) (*Color, error) {
...
func (r *ApiRouter) UpdateColor(ctx context.Context, request *UpdateColorRequest) (*Color, error) {
	child, err := r.GetColorApiClient(request.Name)
	if err != nil {
		return nil, err
	}
...
func (r *ApiRouter) PullColor(request *PullColorRequest, server ColorApi_PullColorServer) error {
	child, err := r.GetColorApiClient(request.Name)
	if err != nil {
		return err
	}
