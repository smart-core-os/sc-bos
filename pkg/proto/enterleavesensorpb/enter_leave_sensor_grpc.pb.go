...
const (
	EnterLeaveSensorApi_PullEnterLeaveEvents_FullMethodName  = "/smartcore.bos.enterleavesensor.v1.EnterLeaveSensorApi/PullEnterLeaveEvents"
	EnterLeaveSensorApi_GetEnterLeaveEvent_FullMethodName    = "/smartcore.bos.enterleavesensor.v1.EnterLeaveSensorApi/GetEnterLeaveEvent"
	EnterLeaveSensorApi_ResetEnterLeaveTotals_FullMethodName = "/smartcore.bos.enterleavesensor.v1.EnterLeaveSensorApi/ResetEnterLeaveTotals"
)
...
var EnterLeaveSensorApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.enterleavesensor.v1.EnterLeaveSensorApi",
	...
	Metadata: "smartcore/bos/enterleavesensor/v1/enter_leave_sensor.proto",
}
...
var EnterLeaveSensorInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.enterleavesensor.v1.EnterLeaveSensorInfo",
