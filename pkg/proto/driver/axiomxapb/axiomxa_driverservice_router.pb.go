...
func (r *DriverServiceRouter) Register(server grpc.ServiceRegistrar) {
...
func (r *DriverServiceRouter) Add(name string, client any) any {
...
func (r *DriverServiceRouter) HoldsType(client any) bool {
	_, ok := client.(AxiomXaDriverServiceClient)
	return ok
}

func (r *DriverServiceRouter) AddAxiomXaDriverServiceClient(name string, client AxiomXaDriverServiceClient) AxiomXaDriverServiceClient {
...
func (r *DriverServiceRouter) RemoveAxiomXaDriverServiceClient(name string) AxiomXaDriverServiceClient {
	res := r.Remove(name)
	if res == nil {
		return nil
	}
...
func (r *DriverServiceRouter) GetAxiomXaDriverServiceClient(name string) (AxiomXaDriverServiceClient, error) {
	res, err := r.Get(name)
	if err != nil {
		return nil, err
	}
...
func (r *DriverServiceRouter) SaveQRCredential(ctx context.Context, request *SaveQRCredentialRequest) (*SaveQRCredentialResponse, error) {
