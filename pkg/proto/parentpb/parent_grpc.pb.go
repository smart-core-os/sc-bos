...
const (
	ParentApi_ListChildren_FullMethodName = "/smartcore.bos.parent.v1.ParentApi/ListChildren"
	ParentApi_PullChildren_FullMethodName = "/smartcore.bos.parent.v1.ParentApi/PullChildren"
)
...
var ParentApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.parent.v1.ParentApi",
	...
	Metadata: "smartcore/bos/parent/v1/parent.proto",
}
...
var ParentInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.parent.v1.ParentInfo",
