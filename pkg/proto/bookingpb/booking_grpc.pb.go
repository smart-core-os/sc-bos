...
const (
	BookingApi_ListBookings_FullMethodName    = "/smartcore.bos.booking.v1.BookingApi/ListBookings"
	BookingApi_CheckInBooking_FullMethodName  = "/smartcore.bos.booking.v1.BookingApi/CheckInBooking"
	BookingApi_CheckOutBooking_FullMethodName = "/smartcore.bos.booking.v1.BookingApi/CheckOutBooking"
	BookingApi_CreateBooking_FullMethodName   = "/smartcore.bos.booking.v1.BookingApi/CreateBooking"
	BookingApi_UpdateBooking_FullMethodName   = "/smartcore.bos.booking.v1.BookingApi/UpdateBooking"
	BookingApi_PullBookings_FullMethodName    = "/smartcore.bos.booking.v1.BookingApi/PullBookings"
)
...
var BookingApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.booking.v1.BookingApi",
	...
	Metadata: "smartcore/bos/booking/v1/booking.proto",
}

const (
	BookingInfo_DescribeBooking_FullMethodName = "/smartcore.bos.booking.v1.BookingInfo/DescribeBooking"
)
...
var BookingInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.booking.v1.BookingInfo",
