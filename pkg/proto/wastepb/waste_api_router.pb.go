...
// ApiRouter is a WasteApiServer that allows routing named requests to specific WasteApiClient
...
var _ WasteApiServer = (*ApiRouter)(nil)
...
func (r *ApiRouter) AddWasteApiClient(name string, client WasteApiClient) WasteApiClient {
...
func (r *ApiRouter) RemoveWasteApiClient(name string) WasteApiClient {
	res := r.Remove(name)
	if res == nil {
		return nil
	}
...
func (r *ApiRouter) GetWasteApiClient(name string) (WasteApiClient, error) {
	res, err := r.Get(name)
	if err != nil {
		return nil, err
	}
...
func (r *ApiRouter) ListWasteRecords(ctx context.Context, request *ListWasteRecordsRequest) (*ListWasteRecordsResponse, error) {
...
func (r *ApiRouter) PullWasteRecords(request *PullWasteRecordsRequest, server WasteApi_PullWasteRecordsServer) error {
	child, err := r.GetWasteApiClient(request.Name)
	if err != nil {
		return err
	}
