...
func (m *ModelServer) Register(server *grpc.Server) {
	RegisterWasteApiServer(server, m)
}
...
func (m *ModelServer) ListWasteRecords(ctx context.Context, req *ListWasteRecordsRequest) (*ListWasteRecordsResponse, error) {
...
func (m *ModelServer) PullWasteRecords(request *PullWasteRecordsRequest, server WasteApi_PullWasteRecordsServer) error {
