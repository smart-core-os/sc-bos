...
func (r *MemorySettingsApiRouter) UpdateDemand(ctx context.Context, request *UpdateDemandRequest) (*ElectricDemand, error) {
...
func (r *MemorySettingsApiRouter) CreateMode(ctx context.Context, request *CreateModeRequest) (*ElectricMode, error) {
	child, err := r.GetMemorySettingsApiClient(request.Name)
	if err != nil {
		return nil, err
	}
...
func (r *MemorySettingsApiRouter) UpdateMode(ctx context.Context, request *UpdateModeRequest) (*ElectricMode, error) {
	child, err := r.GetMemorySettingsApiClient(request.Name)
	if err != nil {
		return nil, err
	}
