...
import (
	...
	"github.com/smart-core-os/sc-bos/pkg/proto/electricpb/segmentpb"
)
...
func MagnitudeAt(t time.Time, mode *electricpb.ElectricMode) (level float32, ok bool) {
...
func MaxSegmentAfter(t time.Time, mode *electricpb.ElectricMode) (index int) {
