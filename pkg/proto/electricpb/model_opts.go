...
var DefaultModelOptions = []resource.Option{
	WithInitialDemand(&ElectricDemand{
		Current: 0,
		Voltage: &defaultInitialVoltage,
		Rating:  13,
	}),
	WithInitialActiveMode(&ElectricMode{}),
...
func WithInitialDemand(demand *ElectricDemand) resource.Option {
...
func WithInitialActiveMode(activeMode *ElectricMode) resource.Option {
...
func WithInitialMode(mode ...*ElectricMode) resource.Option {
