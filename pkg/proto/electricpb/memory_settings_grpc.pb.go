...
type MemorySettingsApiClient interface {
	UpdateDemand(ctx context.Context, in *UpdateDemandRequest, opts ...grpc.CallOption) (*ElectricDemand, error)
	...
	CreateMode(ctx context.Context, in *CreateModeRequest, opts ...grpc.CallOption) (*ElectricMode, error)
	UpdateMode(ctx context.Context, in *UpdateModeRequest, opts ...grpc.CallOption) (*ElectricMode, error)
...
func (c *memorySettingsApiClient) UpdateDemand(ctx context.Context, in *UpdateDemandRequest, opts ...grpc.CallOption) (*ElectricDemand, error) {
...
func (c *memorySettingsApiClient) CreateMode(ctx context.Context, in *CreateModeRequest, opts ...grpc.CallOption) (*ElectricMode, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *memorySettingsApiClient) UpdateMode(ctx context.Context, in *UpdateModeRequest, opts ...grpc.CallOption) (*ElectricMode, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ElectricMode)
...
type MemorySettingsApiServer interface {
	UpdateDemand(context.Context, *UpdateDemandRequest) (*ElectricDemand, error)
	// Create a new mode in the device.
	// Do not specify the id, this will be provided by the server.
	// This will not validate that exactly one normal mode exists,
	// the ClearActiveMode method will choose the first normal mode found.
	CreateMode(context.Context, *CreateModeRequest) (*ElectricMode, error)
	UpdateMode(context.Context, *UpdateModeRequest) (*ElectricMode, error)
	// Delete an existing mode.
	// Returns NOT_FOUND if the mode, identified by id, is not found. See allow_missing.
...
func (UnimplementedMemorySettingsApiServer) UpdateDemand(context.Context, *UpdateDemandRequest) (*ElectricDemand, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateDemand not implemented")
}
func (UnimplementedMemorySettingsApiServer) CreateMode(context.Context, *CreateModeRequest) (*ElectricMode, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateMode not implemented")
}
func (UnimplementedMemorySettingsApiServer) UpdateMode(context.Context, *UpdateModeRequest) (*ElectricMode, error) {
...
var MemorySettingsApi_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "smartcore/bos/electric/internal/memory_settings.proto",
}
