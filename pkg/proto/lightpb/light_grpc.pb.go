...
const (
	LightApi_UpdateBrightness_FullMethodName = "/smartcore.bos.light.v1.LightApi/UpdateBrightness"
	LightApi_GetBrightness_FullMethodName    = "/smartcore.bos.light.v1.LightApi/GetBrightness"
	LightApi_PullBrightness_FullMethodName   = "/smartcore.bos.light.v1.LightApi/PullBrightness"
)
...
var LightApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.light.v1.LightApi",
	...
	Metadata: "smartcore/bos/light/v1/light.proto",
}

const (
	LightInfo_DescribeBrightness_FullMethodName = "/smartcore.bos.light.v1.LightInfo/DescribeBrightness"
)
...
var LightInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.light.v1.LightInfo",
