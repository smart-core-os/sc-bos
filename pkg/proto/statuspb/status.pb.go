// Deprecated: The status trait is superseded by the health trait (smartcore.bos.health.v1).
// Migrate consumers to use HealthApi instead.
...
const file_smartcore_bos_status_v1_status_proto_rawDesc = "" +
	...
	"changeTime\x12I\n" +
	"\x0ecurrent_status\x18\x03 \x01(\v2\".smartcore.bos.status.v1.StatusLogR\rcurrentStatus2\xf8\x01\n" +
	"\tStatusApi\x12h\n" +
	"\x10GetCurrentStatus\x120.smartcore.bos.status.v1.GetCurrentStatusRequest\x1a\".smartcore.bos.status.v1.StatusLog\x12|\n" +
	"\x11PullCurrentStatus\x121.smartcore.bos.status.v1.PullCurrentStatusRequest\x1a2.smartcore.bos.status.v1.PullCurrentStatusResponse0\x01\x1a\x03\x88\x02\x01B4Z2github.com/smart-core-os/sc-bos/pkg/proto/statuspbb\x06proto3"
