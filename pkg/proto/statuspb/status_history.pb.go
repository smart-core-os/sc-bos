...
func (x *ListCurrentStatusHistoryRequest) GetPeriod() *timepb.Period {
	if x != nil {
		return x.Period
	}
	return nil
...
const file_smartcore_bos_status_v1_status_history_proto_rawDesc = "" +
	"\n" +
	",smartcore/bos/status/v1/status_history.proto\x12\x17smartcore.bos.status.v1\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a$smartcore/bos/status/v1/status.proto\x1a(smartcore/bos/types/time/v1/period.proto\"\x99\x01\n" +
	...
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize2\xa6\x01\n" +
	"\rStatusHistory\x12\x8f\x01\n" +
	"\x18ListCurrentStatusHistory\x128.smartcore.bos.status.v1.ListCurrentStatusHistoryRequest\x1a9.smartcore.bos.status.v1.ListCurrentStatusHistoryResponse\x1a\x03\x88\x02\x01B4Z2github.com/smart-core-os/sc-bos/pkg/proto/statuspbb\x06proto3"
...
var file_smartcore_bos_status_v1_status_history_proto_depIdxs = []int32{
	...
	5, // 2: smartcore.bos.status.v1.ListCurrentStatusHistoryRequest.period:type_name -> smartcore.bos.types.time.v1.Period
