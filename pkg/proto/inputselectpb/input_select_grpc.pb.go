...
const (
	InputSelectApi_UpdateInput_FullMethodName = "/smartcore.bos.inputselect.v1.InputSelectApi/UpdateInput"
	InputSelectApi_GetInput_FullMethodName    = "/smartcore.bos.inputselect.v1.InputSelectApi/GetInput"
	InputSelectApi_PullInput_FullMethodName   = "/smartcore.bos.inputselect.v1.InputSelectApi/PullInput"
)
...
var InputSelectApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.inputselect.v1.InputSelectApi",
	...
	Metadata: "smartcore/bos/inputselect/v1/input_select.proto",
}

const (
	InputSelectInfo_DescribeInput_FullMethodName = "/smartcore.bos.inputselect.v1.InputSelectInfo/DescribeInput"
)
...
var InputSelectInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.inputselect.v1.InputSelectInfo",
