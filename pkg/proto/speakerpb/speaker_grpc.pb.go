...
const (
	SpeakerApi_GetVolume_FullMethodName    = "/smartcore.bos.speaker.v1.SpeakerApi/GetVolume"
	SpeakerApi_UpdateVolume_FullMethodName = "/smartcore.bos.speaker.v1.SpeakerApi/UpdateVolume"
	SpeakerApi_PullVolume_FullMethodName   = "/smartcore.bos.speaker.v1.SpeakerApi/PullVolume"
)
...
var SpeakerApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.speaker.v1.SpeakerApi",
	...
	Metadata: "smartcore/bos/speaker/v1/speaker.proto",
}

const (
	SpeakerInfo_DescribeVolume_FullMethodName = "/smartcore.bos.speaker.v1.SpeakerInfo/DescribeVolume"
)
...
var SpeakerInfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartcore.bos.speaker.v1.SpeakerInfo",
