...
func PeriodsConnected(p1, p2 *timepb.Period) bool {
	if p1 == nil || p2 == nil {
		return false
	}
...
func PeriodsIntersect(p1, p2 *timepb.Period) bool {
	if p1 == nil || p2 == nil {
		return false
	}
...
func AllTime() *timepb.Period {
	return &timepb.Period{}
}

func PeriodBetween(t1, t2 *timestamppb.Timestamp) *timepb.Period {
	return &timepb.Period{StartTime: t1, EndTime: t2}
}

func PeriodBefore(t *timestamppb.Timestamp) *timepb.Period {
	return &timepb.Period{EndTime: t}
}

func PeriodOnOrAfter(t *timestamppb.Timestamp) *timepb.Period {
	return &timepb.Period{StartTime: t}
}
