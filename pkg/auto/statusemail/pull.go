...
func pullFrom(ctx context.Context, name string, client statuspb.StatusApiClient, c chan<- *statuspb.StatusLog, opts ...pull.Option) error {
	puller := statusLogPuller{client: client, name: name}
	return pull.Changes[*statuspb.StatusLog](ctx, puller, c, opts...)
}
