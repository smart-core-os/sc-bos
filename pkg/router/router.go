// Package router supports the implementation of trait routers, as generated by protoc-gen-router.
//
// Deprecated: trait routing functionality is now provided by internal/router, which does not require per-trait code generation.
package router
