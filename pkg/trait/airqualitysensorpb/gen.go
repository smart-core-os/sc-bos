...
//go:generate protomod protoc -- -I ../../.. --router_opt=outputPkg=github.com/smart-core-os/sc-bos/pkg/trait/airqualitysensorpb --router_out=../../.. --wrapper_opt=outputPkg=github.com/smart-core-os/sc-bos/pkg/trait/airqualitysensorpb --wrapper_out=../../.. github.com/smart-core-os/sc-bos/sc-api/protobuf/traits/air_quality_sensor.proto
