...
//go:generate protomod protoc -- -I ../../.. --router_opt=outputPkg=github.com/smart-core-os/sc-bos/pkg/trait/enterleavesensorpb --router_out=../../.. --wrapper_opt=outputPkg=github.com/smart-core-os/sc-bos/pkg/trait/enterleavesensorpb --wrapper_out=../../.. github.com/smart-core-os/sc-bos/sc-api/protobuf/traits/enter_leave_sensor.proto
