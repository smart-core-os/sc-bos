...
export class AmbientBrightnessSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): AmbientBrightnessSupport;
  hasResourceSupport(): boolean;
  clearResourceSupport(): AmbientBrightnessSupport;

  getBrightnessLux(): smartcore_bos_types_v1_number_pb.FloatBounds | undefined;
  setBrightnessLux(value?: smartcore_bos_types_v1_number_pb.FloatBounds): AmbientBrightnessSupport;
...
export namespace AmbientBrightnessSupport {
  export type AsObject = {
    ...
    brightnessLux?: smartcore_bos_types_v1_number_pb.FloatBounds.AsObject;
  };
}
