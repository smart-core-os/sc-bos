...
export class Consumable extends jspb.Message {
  ...
  setPicture(value?: smartcore_bos_types_v1_image_pb.Image): Consumable;
  hasPicture(): boolean;
...
export namespace Consumable {
  ...
  export class Portion extends jspb.Message {
    ...
    getBounds(): smartcore_bos_types_v1_number_pb.FloatBounds | undefined;
    setBounds(value?: smartcore_bos_types_v1_number_pb.FloatBounds): Portion;
    hasBounds(): boolean;
    clearBounds(): Portion;
  ...
  export namespace Portion {
    export type AsObject = {
      ...
      bounds?: smartcore_bos_types_v1_number_pb.FloatBounds.AsObject;
      step: number;
    };
  }
