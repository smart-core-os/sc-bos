...
proto.smartcore.bos.boot.v1 = require('./boot_history_pb.js');
 ...
 * @final
 */
proto.smartcore.bos.boot.v1.BootHistoryClient =
 ...
 * @final
 */
proto.smartcore.bos.boot.v1.BootHistoryPromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options.format = 'text';
