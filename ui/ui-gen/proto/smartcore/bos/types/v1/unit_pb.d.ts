...
export class AudioLevel extends jspb.Message {
  ...
  getGainTween(): smartcore_bos_types_v1_tween_pb.Tween | undefined;
  setGainTween(value?: smartcore_bos_types_v1_tween_pb.Tween): AudioLevel;
...
export namespace AudioLevel {
  export type AsObject = {
    gain: number;
    gainTween?: smartcore_bos_types_v1_tween_pb.Tween.AsObject;
    targetGain: number;
    muted: boolean;
  };
}
