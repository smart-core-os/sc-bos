...
export class Int32Attributes extends jspb.Message {
  ...
  getRampSupport(): smartcore_bos_types_v1_tween_pb.TweenSupport;
  setRampSupport(value: smartcore_bos_types_v1_tween_pb.TweenSupport): Int32Attributes;
...
export namespace Int32Attributes {
  export type AsObject = {
    ...
    rampSupport: smartcore_bos_types_v1_tween_pb.TweenSupport;
...
export class FloatAttributes extends jspb.Message {
  ...
  getRampSupport(): smartcore_bos_types_v1_tween_pb.TweenSupport;
  setRampSupport(value: smartcore_bos_types_v1_tween_pb.TweenSupport): FloatAttributes;
