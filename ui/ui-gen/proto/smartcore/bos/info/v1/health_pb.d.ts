...
import * as smartcore_bos_types_v1_connection_pb from '../../../../smartcore/bos/types/v1/connection_pb'; // proto import: "smartcore/bos/types/v1/connection.proto"
...
export class ConnectionHealth extends jspb.Message {
  getStatus(): smartcore_bos_types_v1_connection_pb.Connectivity;
  setStatus(value: smartcore_bos_types_v1_connection_pb.Connectivity): ConnectionHealth;
...
export namespace ConnectionHealth {
  export type AsObject = {
    status: smartcore_bos_types_v1_connection_pb.Connectivity;
...
export class CommHealth extends jspb.Message {
  getStatus(): smartcore_bos_types_v1_connection_pb.CommStatus;
  setStatus(value: smartcore_bos_types_v1_connection_pb.CommStatus): CommHealth;
...
export namespace CommHealth {
  export type AsObject = {
    status: smartcore_bos_types_v1_connection_pb.CommStatus;
