...
export class UpdateAccountPermissionsRequest extends jspb.Message {
  getChangeType(): smartcore_bos_types_v1_change_pb.ChangeType;
  setChangeType(value: smartcore_bos_types_v1_change_pb.ChangeType): UpdateAccountPermissionsRequest;
...
export namespace UpdateAccountPermissionsRequest {
  export type AsObject = {
    changeType: smartcore_bos_types_v1_change_pb.ChangeType;
    permissionsList: Array<Permission.AsObject>;
  };
}
