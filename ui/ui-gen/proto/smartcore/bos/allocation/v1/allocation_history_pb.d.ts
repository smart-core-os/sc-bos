...
export class AllocationRecord extends jspb.Message {
  getAllocation(): smartcore_bos_allocation_v1_allocation_pb.Allocation | undefined;
  setAllocation(value?: smartcore_bos_allocation_v1_allocation_pb.Allocation): AllocationRecord;
...
export namespace AllocationRecord {
  export type AsObject = {
    allocation?: smartcore_bos_allocation_v1_allocation_pb.Allocation.AsObject;
