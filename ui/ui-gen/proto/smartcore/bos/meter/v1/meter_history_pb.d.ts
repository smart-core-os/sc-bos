...
export class MeterReadingRecord extends jspb.Message {
  getMeterReading(): smartcore_bos_meter_v1_meter_pb.MeterReading | undefined;
  setMeterReading(value?: smartcore_bos_meter_v1_meter_pb.MeterReading): MeterReadingRecord;
...
export namespace MeterReadingRecord {
  export type AsObject = {
    meterReading?: smartcore_bos_meter_v1_meter_pb.MeterReading.AsObject;
...
export class ListMeterReadingHistoryRequest extends jspb.Message {
  ...
  setPeriod(value?: smartcore_bos_types_time_v1_period_pb.Period): ListMeterReadingHistoryRequest;
  hasPeriod(): boolean;
