...
export class StatusLogRecord extends jspb.Message {
  getCurrentStatus(): smartcore_bos_status_v1_status_pb.StatusLog | undefined;
  setCurrentStatus(value?: smartcore_bos_status_v1_status_pb.StatusLog): StatusLogRecord;
...
export namespace StatusLogRecord {
  export type AsObject = {
    currentStatus?: smartcore_bos_status_v1_status_pb.StatusLog.AsObject;
...
export class ListCurrentStatusHistoryRequest extends jspb.Message {
  ...
  setPeriod(value?: smartcore_bos_types_time_v1_period_pb.Period): ListCurrentStatusHistoryRequest;
  hasPeriod(): boolean;
