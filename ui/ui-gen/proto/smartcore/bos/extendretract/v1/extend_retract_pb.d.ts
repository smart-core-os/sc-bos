...
export class Extension extends jspb.Message {
  ...
  getExtendTween(): smartcore_bos_types_v1_tween_pb.Tween | undefined;
  setExtendTween(value?: smartcore_bos_types_v1_tween_pb.Tween): Extension;
...
export namespace Extension {
  export type AsObject = {
    ...
    extendPreset: string;
    extendTween?: smartcore_bos_types_v1_tween_pb.Tween.AsObject;
...
export class ExtensionSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): ExtensionSupport;
  ...
  getTweenSupport(): smartcore_bos_types_v1_tween_pb.TweenSupport;
  setTweenSupport(value: smartcore_bos_types_v1_tween_pb.TweenSupport): ExtensionSupport;
...
export namespace ExtensionSupport {
  export type AsObject = {
    ...
    step: number;
    tweenSupport: smartcore_bos_types_v1_tween_pb.TweenSupport;
