...
export class VolumeSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): VolumeSupport;
  hasResourceSupport(): boolean;
  clearResourceSupport(): VolumeSupport;

  getVolumeAttributes(): smartcore_bos_types_v1_number_pb.FloatAttributes | undefined;
  setVolumeAttributes(value?: smartcore_bos_types_v1_number_pb.FloatAttributes): VolumeSupport;
  hasVolumeAttributes(): boolean;
  clearVolumeAttributes(): VolumeSupport;

  getMuteSupport(): smartcore_bos_types_v1_unit_pb.MuteSupport;
  setMuteSupport(value: smartcore_bos_types_v1_unit_pb.MuteSupport): VolumeSupport;
...
export namespace VolumeSupport {
  export type AsObject = {
    ...
    volumeAttributes?: smartcore_bos_types_v1_number_pb.FloatAttributes.AsObject;
...
export class UpdateSpeakerVolumeRequest extends jspb.Message {
  ...
  getVolume(): smartcore_bos_types_v1_unit_pb.AudioLevel | undefined;
  setVolume(value?: smartcore_bos_types_v1_unit_pb.AudioLevel): UpdateSpeakerVolumeRequest;
  hasVolume(): boolean;
...
export namespace UpdateSpeakerVolumeRequest {
  export type AsObject = {
    name: string;
    volume?: smartcore_bos_types_v1_unit_pb.AudioLevel.AsObject;
    delta: boolean;
...
export class PullSpeakerVolumeResponse extends jspb.Message {
  ...
  setChangesList(value: Array<smartcore_bos_types_v1_unit_pb.AudioLevelChange>): PullSpeakerVolumeResponse;
