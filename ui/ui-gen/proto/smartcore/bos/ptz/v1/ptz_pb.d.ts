...
export class PtzMovement extends jspb.Message {
  ...
  getSpeedTween(): smartcore_bos_types_v1_tween_pb.Tween | undefined;
  setSpeedTween(value?: smartcore_bos_types_v1_tween_pb.Tween): PtzMovement;
...
export namespace PtzMovement {
  export type AsObject = {
    ...
    speed: number;
    speedTween?: smartcore_bos_types_v1_tween_pb.Tween.AsObject;
    targetSpeed: number;
  };
}
...
export class PtzPosition extends jspb.Message {
  ...
  getTween(): smartcore_bos_types_v1_tween_pb.Tween | undefined;
  setTween(value?: smartcore_bos_types_v1_tween_pb.Tween): PtzPosition;
  hasTween(): boolean;
...
export namespace PtzPosition {
  export type AsObject = {
    ...
    tween?: smartcore_bos_types_v1_tween_pb.Tween.AsObject;
...
export class PtzSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): PtzSupport;
