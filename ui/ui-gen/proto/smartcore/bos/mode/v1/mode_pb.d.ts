...
export class ModesSupport extends jspb.Message {
  getModeValuesSupport(): smartcore_bos_types_v1_info_pb.ResourceSupport | undefined;
  setModeValuesSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): ModesSupport;
...
export namespace ModesSupport {
  export type AsObject = {
    modeValuesSupport?: smartcore_bos_types_v1_info_pb.ResourceSupport.AsObject;
