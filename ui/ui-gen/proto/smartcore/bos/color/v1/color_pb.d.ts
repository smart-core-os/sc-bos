...
export class Color extends jspb.Message {
  ...
  getColorTween(): smartcore_bos_types_v1_tween_pb.Tween | undefined;
  setColorTween(value?: smartcore_bos_types_v1_tween_pb.Tween): Color;
...
export namespace Color {
  export type AsObject = {
    ...
    colorTween?: smartcore_bos_types_v1_tween_pb.Tween.AsObject;
...
export class ColorSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): ColorSupport;
  hasResourceSupport(): boolean;
  clearResourceSupport(): ColorSupport;

  getColorAttributes(): smartcore_bos_types_v1_number_pb.Int32Attributes | undefined;
  setColorAttributes(value?: smartcore_bos_types_v1_number_pb.Int32Attributes): ColorSupport;
...
export namespace ColorSupport {
  export type AsObject = {
    ...
    colorAttributes?: smartcore_bos_types_v1_number_pb.Int32Attributes.AsObject;
