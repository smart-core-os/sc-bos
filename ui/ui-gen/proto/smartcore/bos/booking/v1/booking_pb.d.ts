...
import * as smartcore_bos_types_time_v1_unit_pb from '../../../../smartcore/bos/types/time/v1/unit_pb'; // proto import: "smartcore/bos/types/time/v1/unit.proto"
...
export class Booking extends jspb.Message {
  ...
  getBooked(): smartcore_bos_types_time_v1_period_pb.Period | undefined;
  setBooked(value?: smartcore_bos_types_time_v1_period_pb.Period): Booking;
  hasBooked(): boolean;
  clearBooked(): Booking;

  getCheckIn(): smartcore_bos_types_time_v1_period_pb.Period | undefined;
  setCheckIn(value?: smartcore_bos_types_time_v1_period_pb.Period): Booking;
  hasCheckIn(): boolean;
...
export namespace Booking {
  export type AsObject = {
    ...
    title: string;
    ownerName: string;
    booked?: smartcore_bos_types_time_v1_period_pb.Period.AsObject;
    checkIn?: smartcore_bos_types_time_v1_period_pb.Period.AsObject;
...
export class BookingSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): BookingSupport;
  ...
  getTimeResolution(): smartcore_bos_types_time_v1_unit_pb.Unit;
  setTimeResolution(value: smartcore_bos_types_time_v1_unit_pb.Unit): BookingSupport;
...
export namespace BookingSupport {
  export type AsObject = {
    ...
    timeResolution: smartcore_bos_types_time_v1_unit_pb.Unit;
  };
...
export class ListBookingsRequest extends jspb.Message {
  ...
  getBookingIntersects(): smartcore_bos_types_time_v1_period_pb.Period | undefined;
  setBookingIntersects(value?: smartcore_bos_types_time_v1_period_pb.Period): ListBookingsRequest;
