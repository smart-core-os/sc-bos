...
export class Brightness extends jspb.Message {
  ...
  getBrightnessTween(): smartcore_bos_types_v1_tween_pb.Tween | undefined;
  setBrightnessTween(value?: smartcore_bos_types_v1_tween_pb.Tween): Brightness;
...
export class BrightnessSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): BrightnessSupport;
  hasResourceSupport(): boolean;
  clearResourceSupport(): BrightnessSupport;

  getBrightnessAttributes(): smartcore_bos_types_v1_number_pb.Int32Attributes | undefined;
  setBrightnessAttributes(value?: smartcore_bos_types_v1_number_pb.Int32Attributes): BrightnessSupport;
...
export namespace BrightnessSupport {
  export type AsObject = {
    ...
    brightnessAttributes?: smartcore_bos_types_v1_number_pb.Int32Attributes.AsObject;
