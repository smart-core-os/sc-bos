...
export class AirTemperature extends jspb.Message {
  ...
  getTemperatureSetPoint(): smartcore_bos_types_v1_unit_pb.Temperature | undefined;
  setTemperatureSetPoint(value?: smartcore_bos_types_v1_unit_pb.Temperature): AirTemperature;
  hasTemperatureSetPoint(): boolean;
  clearTemperatureSetPoint(): AirTemperature;

  getTemperatureSetPointDelta(): smartcore_bos_types_v1_unit_pb.Temperature | undefined;
  setTemperatureSetPointDelta(value?: smartcore_bos_types_v1_unit_pb.Temperature): AirTemperature;
  ...
  getAmbientTemperature(): smartcore_bos_types_v1_unit_pb.Temperature | undefined;
  setAmbientTemperature(value?: smartcore_bos_types_v1_unit_pb.Temperature): AirTemperature;
  ...
  getDewPoint(): smartcore_bos_types_v1_unit_pb.Temperature | undefined;
  setDewPoint(value?: smartcore_bos_types_v1_unit_pb.Temperature): AirTemperature;
  hasDewPoint(): boolean;
...
export namespace AirTemperature {
  export type AsObject = {
    ...
    temperatureSetPoint?: smartcore_bos_types_v1_unit_pb.Temperature.AsObject;
    temperatureSetPointDelta?: smartcore_bos_types_v1_unit_pb.Temperature.AsObject;
    temperatureRange?: TemperatureRange.AsObject;
    ambientTemperature?: smartcore_bos_types_v1_unit_pb.Temperature.AsObject;
    ambientHumidity?: number;
    dewPoint?: smartcore_bos_types_v1_unit_pb.Temperature.AsObject;
  };
...
export class TemperatureRange extends jspb.Message {
  getLow(): smartcore_bos_types_v1_unit_pb.Temperature | undefined;
  setLow(value?: smartcore_bos_types_v1_unit_pb.Temperature): TemperatureRange;
  hasLow(): boolean;
  clearLow(): TemperatureRange;

  getHigh(): smartcore_bos_types_v1_unit_pb.Temperature | undefined;
  setHigh(value?: smartcore_bos_types_v1_unit_pb.Temperature): TemperatureRange;
  hasHigh(): boolean;
  clearHigh(): TemperatureRange;

  getIdeal(): smartcore_bos_types_v1_unit_pb.Temperature | undefined;
  setIdeal(value?: smartcore_bos_types_v1_unit_pb.Temperature): TemperatureRange;
  hasIdeal(): boolean;
...
export namespace TemperatureRange {
  export type AsObject = {
    low?: smartcore_bos_types_v1_unit_pb.Temperature.AsObject;
    high?: smartcore_bos_types_v1_unit_pb.Temperature.AsObject;
    ideal?: smartcore_bos_types_v1_unit_pb.Temperature.AsObject;
  };
}
...
export class AirTemperatureSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): AirTemperatureSupport;
  hasResourceSupport(): boolean;
  clearResourceSupport(): AirTemperatureSupport;

  getNativeUnit(): smartcore_bos_types_v1_unit_pb.TemperatureUnit;
  setNativeUnit(value: smartcore_bos_types_v1_unit_pb.TemperatureUnit): AirTemperatureSupport;
...
export namespace AirTemperatureSupport {
  export type AsObject = {
    ...
    nativeUnit: smartcore_bos_types_v1_unit_pb.TemperatureUnit;
