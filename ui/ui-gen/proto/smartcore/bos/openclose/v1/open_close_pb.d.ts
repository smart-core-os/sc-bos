...
import * as smartcore_bos_types_v1_tween_pb from '../../../../smartcore/bos/types/v1/tween_pb'; // proto import: "smartcore/bos/types/v1/tween.proto"
...
export class OpenClosePosition extends jspb.Message {
  ...
  getOpenPercentTween(): smartcore_bos_types_v1_tween_pb.Tween | undefined;
  setOpenPercentTween(value?: smartcore_bos_types_v1_tween_pb.Tween): OpenClosePosition;
...
export namespace OpenClosePosition {
  export type AsObject = {
    openPercent: number;
    openPercentTween?: smartcore_bos_types_v1_tween_pb.Tween.AsObject;
...
export class PositionsSupport extends jspb.Message {
  ...
  setResourceSupport(value?: smartcore_bos_types_v1_info_pb.ResourceSupport): PositionsSupport;
  hasResourceSupport(): boolean;
  clearResourceSupport(): PositionsSupport;

  getOpenPercentAttributes(): smartcore_bos_types_v1_number_pb.FloatAttributes | undefined;
  setOpenPercentAttributes(value?: smartcore_bos_types_v1_number_pb.FloatAttributes): PositionsSupport;
...
export namespace PositionsSupport {
  export type AsObject = {
    ...
    openPercentAttributes?: smartcore_bos_types_v1_number_pb.FloatAttributes.AsObject;
