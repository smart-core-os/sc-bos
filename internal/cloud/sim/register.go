...
// Media types for the EST-shaped device enrolment exchange.
const (
...
// deviceRegister handles POST /v1/device/register (EST simpleenroll in shape).
...
// (verifying its signature). The body is base64 per Content-Transfer-Encoding,
// matching application/pkcs10.
