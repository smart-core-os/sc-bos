...
// deviceRenew handles POST /v1/device/certificate/renew (inspired by EST simplereenroll, not an EST implementation). It is authorised by the controller's current client certificate (mTLS),
