#!/usr/bin/env bash
# 01-build.sh — build everything the demo needs (run on the Rocky host).
#
...
#       --ignorefile augments the repo .dockerignore with this demo's bulky non-input dirs so the
